...
final class strayLog extends strayASingleton
{
  ...
  public function SysError($msg)
  {
    ...
    if ('cli' != STRAY_ENV && true === strayRoutingBootstrap::fGetInstance()->GetRequest()->IsDebug())
  ...
  public function SysNotice($msg)
  {
    ...
    if ('cli' != STRAY_ENV && true === strayRoutingBootstrap::fGetInstance()->GetRequest()->IsDebug())
        strayProfiler::fGetInstance()->AddLog(strayProfiler::LEVEL_SYS_NOTICE, $msg);
  }
  ...
  public function FwDebug($msg)
  {
    ...
    if ('cli' != STRAY_ENV && true === strayRoutingBootstrap::fGetInstance()->GetRequest()->IsDebug())
        strayProfiler::fGetInstance()->AddLog(strayProfiler::LEVEL_FW_DEBUG, $msg);
  }
  ...
  public function Notice($msg)
  {
    ...
    if ('cli' != STRAY_ENV && true === strayRoutingBootstrap::fGetInstance()->GetRequest()->IsDebug())
        strayProfiler::fGetInstance()->AddLog(strayProfiler::LEVEL_USER_NOTICE, $msg);
  }
}
